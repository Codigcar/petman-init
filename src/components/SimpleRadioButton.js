...
class RadioForm extends React.Component {
    ...
    static defaultProps = {
        radio_props: [],
        initial: 0,
        buttonColor: Styles.colors.cian,
        selectedButtonColor: Styles.colors.cian,
        formHorizontal: false,
        labelHorizontal: true,
        animation: true,
        labelColor: Styles.colors.gris,
        selectedLabelColor: Styles.colors.gris,
        wrapStyle: {},
        disabled: false
    }
...
RadioButtonInput.defaultProps = {
    buttonInnerColor: Styles.colors.cian,
    buttonOuterColor: Styles.colors.gris,
    disabled: false
}

class RadioButtonLabel extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            isSelected: false,
...
var style = StyleSheet.create({
    ...
    radio: {
        ...
        borderColor: Styles.colors.gris,
        borderRadius: 30,
    },
    ...
    radioActive: {
        width: 20,
        height: 20,
        backgroundColor: Styles.colors.cian,
    },
